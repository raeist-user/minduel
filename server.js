...
// --- Socket.io: live forum updates (new posts, replies, reactions, pin/lock/delete) ---
...
// Lets forumController.js reach the socket server via req.app.get('io')
// without importing server.js (which would create a require cycle).
app.set('io', io);
